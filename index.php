<?php include ("template/secciones/bd.php");
//seleccionar registros servicios
$sentencia=$conexion->prepare("SELECT * FROM tbl_servicios");
$sentencia->execute();
$lista_servicios=$sentencia->fetchAll(PDO::FETCH_ASSOC);
//seleccionar registros portafolio
...
<html lang="en">
    ...
    <body id="page-top">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal<?php echo $registro['ID']; ?>">
                                ...
                                <img class="img-fluid" src="template/img/portfolio/<?php echo $registro['imagen']; ?>" alt="..." />
                            </a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img class="img-fluid d-block mx-auto" src="template/img/portfolio/<?php echo $registro['imagen']; ?>" alt="..." />
            ...
            <div class="container">
                ...
                foreach ($lista_entradas as $registro){?>
                    <li <?php echo (($contador%2)==0)?'class="timeline-inverted"':""; ?>>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="template/img/about/<?php echo $registro['imagen']; ?>" alt="..." /></div>
                ...
                <?php foreach ($lista_equipo as $registro){?>
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="template/img/team/<?php echo $registro['imagen']; ?>" alt="..." />
                            <h4><?php echo $registro['nombrecompleto']; ?></h4>
                            <p class="text-muted"><?php echo $registro['puesto']; ?></p>
                            <a class="btn btn-dark btn-social mx-2" href="<?php echo $registro['twitter']; ?>" aria-label="Parveen Anand Twitter Profile"><i class="fab fa-twitter"></i></a>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">Copyright &copy; portafolio-2023</div>
